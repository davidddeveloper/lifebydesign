  ...
  return (
    <section className="bg-gray-100 py-24 md:py-16 lg:py-16 relative overflow-hidden "> {/*bg-gray-100*/}
      <div className="container mx-auto pt-10 z-10">
        <div className="flex items-center"> {/* grid lg:grid-cols-[300px_1fr_100px] ||2. items-center gap-8 grid lg:grid-cols-[220px_1fr_0px]*/}
          {/* Left Person Image */}
          ...
          <div className="text-center max-w-5xl md:pr-2 md:min-w-[650px] lg:max-w-5xl mx-auto"> {/** border-2 border-[#177fc9] rounded-lg p-8 */}
            <h1 className="text-5xl px-2 md:text-5xl lg:text-5xl xl:text-5xl font-black text-gray-900 mb-6 leading-tight text-balance uppercase">
              {heading}
            </h1>
            <p className="px-4 text-lg md:text-xl lg:text-[17px] xl:text-xl text-gray-700 leading-relaxed lg:text-nowrap">
              {description}
            </p>
