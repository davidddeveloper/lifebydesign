...
export default function Home() {
  ...
  const handleFormSubmit = async (formData: any) => {
    ...
    try {
      ...
      const parsedFields = {
        ...results.fields,
        evidence_points: typeof results.fields.evidence_points === 'string'
          ? JSON.parse(results.fields.evidence_points)
          : results.fields.evidence_points,
        scores: typeof results.fields.scores === 'string'
          ? JSON.parse(results.fields.scores)
          : results.fields.scores,
        revenue_impact: typeof results.fields.revenue_impact === 'string'
          ? JSON.parse(results.fields.revenue_impact)
          : results.fields.revenue_impact,
        quick_win: typeof results.fields.quick_win === 'string'
      ...
      <div className="max-w-md w-full">
        ...
        >
          ...
          <motion.div
            ...
            className="w-24 h-24 mx-auto mb-8 bg-gradient-to-br from-orange-600 to-orange-400 rounded-full flex items-center justify-center text-white text-4xl shadow-2xl"
          >
            🎯
          </motion.div>
          ...
          <p className="text-gray-600 mb-8">
            Our AI is identifying your #1 constraint
          </p>
          ...
          <div className="mt-12 p-6 bg-white rounded-xl shadow-lg border border-gray-100">
            <p className="text-sm text-gray-600 italic">
              "Did you know? 80% of business problems come from just one constraint. 
